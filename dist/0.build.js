...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3cc1d645_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Build_vue__ = __webpack_require__(587);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__sections_BuildKnife_vue__ = __webpack_require__(580);
//
//
//
//
...
var desktop = __webpack_require__(158);
var mobile = __webpack_require__(158);
...
var cursor = __webpack_require__(511);
var cursor2 = __webpack_require__(577);
/* harmony default export */ __webpack_exports__["a"] = ({
  props: ["step"],
  data() {
    return {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_clickaway__ = __webpack_require__(578);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__molecules_BuildImage_vue__ = __webpack_require__(579);
//
//
//
//
...
var placeholder = __webpack_require__(533);
...
var placeholder = __webpack_require__(530);
var placeholder = __webpack_require__(531);
...
var placeholder = __webpack_require__(532);
...
// module
exports.push([module.i, ".form-holder label[data-v-55a20ca0]{font-weight:700;margin-left:.5rem;margin-right:.5rem}.form-holder .form-text[data-v-55a20ca0]{margin:0}.form-holder input[data-v-55a20ca0],.form-holder select[data-v-55a20ca0],.form-holder textarea[data-v-55a20ca0]{padding-top:1rem;font-weight:700;box-shadow:0 2px 10px 0 rgba(0,0,0,.05),0 3px 7px -2px rgba(0,0,0,.08),0 1px 12px 0 rgba(0,0,0,.09);max-height:calc(100vh - 230px);transition:all .3s cubic-bezier(.68,-.1,.265,1.55)}@media (min-width:768px){.form-holder input[data-v-55a20ca0]:focus,.form-holder select[data-v-55a20ca0]:focus,.form-holder textarea[data-v-55a20ca0]:focus{border-color:#80bdff}}.form-holder input[data-v-55a20ca0],.form-holder select[data-v-55a20ca0]{font-weight:400;padding-top:.5rem}@media (min-width:768px){.form-holder select[data-v-55a20ca0]:focus{transform:none;box-shadow:0 2px 10px 0 rgba(0,0,0,.05),0 3px 7px -2px rgba(0,0,0,.08),0 1px 12px 0 rgba(0,0,0,.09)}}.form-holder .btn[data-v-55a20ca0]{width:100%}.form-holder .form-control[data-v-55a20ca0]{border:1px solid transparent}.container-fluid[data-v-55a20ca0]{display:flex;flex-flow:column wrap;padding-bottom:4.5rem}.row[data-v-55a20ca0]{align-items:stretch;padding:0}.row .card[data-v-55a20ca0]{height:100%}.card[data-v-55a20ca0]{cursor:auto;box-shadow:none}.card[data-v-55a20ca0]:hover{transform:none;box-shadow:0 2px 10px 0 rgba(0,0,0,.05),0 3px 7px -2px rgba(0,0,0,.08),0 1px 12px 0 rgba(0,0,0,.09);box-shadow:none}.card:hover .card-title-strip[data-v-55a20ca0]{background-color:#007bff}.card select[data-v-55a20ca0]{width:100%;cursor:pointer}.card .card-body[data-v-55a20ca0]{min-height:0;padding-bottom:0}.card .card-title-strip[data-v-55a20ca0]{border-top-left-radius:calc(.25rem - 1px);border-top-right-radius:calc(.25rem - 1px)}.card .card-img[data-v-55a20ca0]{border-radius:0}.sidebar[data-v-55a20ca0]{width:100%}.col-form-label>span[data-v-55a20ca0],h4[data-v-55a20ca0]{font-weight:700}@media screen and (min-width:768px){.sticky[data-v-55a20ca0]{position:-webkit-sticky;position:sticky;top:0;padding-top:70px;margin-top:-70px}}.overlay[data-v-55a20ca0]{background:rgba(0,0,0,.2);position:relative}.overlay h4[data-v-55a20ca0]{left:50%;top:50%;transform:translate(-50%,-50%);position:absolute;color:#fff;width:100%;text-align:center}.margin-top[data-v-55a20ca0]{margin-top:1.5rem}.margin-top[data-v-55a20ca0]:first-of-type{margin-top:0}@media screen and (min-width:768px){.margin-top[data-v-55a20ca0]:first-of-type{margin-top:1.5rem}}.margin-top.half[data-v-55a20ca0]{margin-top:.75rem}@media screen and (min-width:992px){.margin-top.half.half-to-full[data-v-55a20ca0]{margin-top:1.5rem}}.margin-top[data-v-55a20ca0]:last-of-type{margin-bottom:1.5rem}@media screen and (min-width:768px){.margin-top[data-v-55a20ca0]:last-of-type{margin-bottom:0}}@media screen and (min-width:992px){.margin-top[data-v-55a20ca0]:first-of-type,.margin-top[data-v-55a20ca0]:nth-of-type(2){margin-top:35px}}.top-spacing[data-v-55a20ca0]{margin:0}.price[data-v-55a20ca0]{letter-spacing:-1px}@media (min-width:769px){.price[data-v-55a20ca0]{margin-bottom:0;transform:translateY(-25%)}}small[data-v-55a20ca0]{vertical-align:top;margin-left:-.6rem}", ""]);
...
// module
exports.push([module.i, ".overlay[data-v-635dd15e]{display:none;cursor:pointer}.overlay.showMe[data-v-635dd15e]{display:block}.overlay .card-img[data-v-635dd15e]{border-radius:0}.large-overlay[data-v-635dd15e]{display:none;cursor:default}.large-overlay.grow[data-v-635dd15e]{position:fixed;z-index:9999;top:0;left:0;width:100%;height:100%;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,.5)}.large-overlay.grow .image-holder[data-v-635dd15e]{position:relative}.large-overlay.grow .image-holder[data-v-635dd15e]:before{content:url(" + escape(__webpack_require__(511)) + ");line-height:1;position:absolute;top:0;right:0;color:#fff;cursor:pointer;background:#dc3545}@media (orientation:portrait){.large-overlay.grow .card-img[data-v-635dd15e]{width:100%;height:auto}}@media (orientation:landscape){.large-overlay.grow .card-img[data-v-635dd15e]{width:auto;height:90%;height:calc(100vh - 114px)}}.large-overlay.grow .close-icon[data-v-635dd15e]{position:absolute;right:0;top:0;transform:translate(-100%,100%)}", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_635dd15e_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_BuildImage_vue__ = __webpack_require__(591);
function injectStyle (ssrContext) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-635dd15e"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_635dd15e_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_BuildImage_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_BuildKnife_vue__ = __webpack_require__(506);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_55a20ca0_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_BuildKnife_vue__ = __webpack_require__(589);
function injectStyle (ssrContext) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-55a20ca0"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_55a20ca0_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_BuildKnife_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(7)("529b0983", content, true, {});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(7)("4c74ad94", content, true, {});
