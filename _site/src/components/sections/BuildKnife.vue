...
<script>
var placeholder = require("../../assets/build/Bowie.jpg");
var placeholder = require("../../assets/build/Fighter.jpg");
var placeholder = require("../../assets/build/Drop Point.jpg");
var placeholder = require("../../assets/build/Boot Knife.jpg");
var placeholder = require("../../assets/build/Maple.jpg");
var placeholder = require("../../assets/build/Buckeye.jpg");
var placeholder = require("../../assets/build/Walnut.jpg");
var placeholder = require("../../assets/build/Ironwood.jpg");
var placeholder = require("../../assets/build/Brass.jpg");
var placeholder = require("../../assets/build/Nickel Silver.jpg");
var placeholder = require("../../assets/build/Copper.jpg");
var placeholder = require("../../assets/build/Elk.jpg");
var placeholder = require("../../assets/build/Tree.jpg");
var placeholder = require("../../assets/build/Wolf.jpg");
var placeholder = require("../../assets/build/Arrows.jpg");
var placeholder = require("../../assets/build/Black.jpg");
var placeholder = require("../../assets/build/Grey Etched.jpg");
var placeholder = require("../../assets/build/Brown.jpg");
var placeholder = require("../../assets/build/Buffed Grind.jpg");
var placeholder = require("../../assets/build/Forge Mark.jpg");
var placeholder = require("../../assets/build/Rough Grind.jpg");
var placeholder = require("../../assets/build/Blade.jpg");
var placeholder = require("../../assets/build/Handle.jpg");
      ...
      buildSteps: [
        {
          ...
          options: [
            ...
            { value: "Drop Point", text: "Drop Point" },
            { value: "Boot Knife", text: "Boot Knife" }
          ]
        },
        {
          grow: false,
          ...
          options: [
            { value: "Buffed Grind", text: "Buffed Grind" },
            { value: "Rough Grind", text: "Rough Grind" },
            { value: "Forge Mark", text: "Forge Mark" },
            { value: "Grey Etched", text: "Grey Etched" }
          ]
        },
        {
          grow: false,
        ...
        },
        {
          ...
          options: [
            ...
            { value: "Nickel Silver", text: "Nickel Silver" },
        ...
        },
        {
          ...
          selected: "Elk",
          options: [
            { src: "Pin.jpg", value: "Elk", text: "Elk" },
            { src: "Pin.jpg", value: "Tree", text: "Tree" },
            { src: "Pin.jpg", value: "Wolf", text: "Wolf" },
            { src: "Pin.jpg", value: "Arrows", text: "Arrows" },
            { src: "PinAlt.jpg", value: "Maple Leaf", text: "Maple Leaf" }
          ]
        },
        {
          grow: false,
